...
class Amazon_SimpleDB_Client implements Amazon_SimpleDB_Interface
{
    ...
    private function _signParameters(array $parameters, $key)
    {
        ...
        if (0 === $signatureVersion) {
            ...
            // uksort($parameters, 'strnatcasecmp');	apparently fails for > 9 params
	    uksort($parameters, 'strcasecmp');
	    // try this (noted in http://developer.amazonwebservices.com/connect/thread.jspa?messageID=75227&#75227)
